...
public class Mushroom extends Item {
    ...
    public Mushroom(PlayScreen playScreen, float x, float y) {
        ...
        setRegion(new TextureRegion(playScreen.getTextureAtlas().findRegion("actors"), 16 * 11, 48, 16, 16));
    ...
    public void checkMovingDirection() {
        ...
        RayCastCallback rayCastCallback = new RayCastCallback() {
            ...
            public float reportRayFixture(Fixture fixture, Vector2 point, Vector2 normal, float fraction) {
                if (fixture.getUserData() == this || fixture.getUserData().getClass() == Character.class || fixture.getUserData() instanceof Enemy) {
                    return 1;
                }
                if (fraction < 1.0f) {
