...
public class Finish extends MapTileObject {
    public Finish(PlayScreen playScreen, float x, float y, TiledMapTileMapObject mapObject) {
    ...
    public void onTrigger(Collider other) {
        if (other.getUserData() instanceof Character) {
            ...
            ((Character) other.getUserData()).levelCompleted();
        }
